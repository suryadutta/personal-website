...
def run_ising(N,T,num_steps,num_burnin,flip_prop, num_analysis, J,B,disable_tqdm=False):
    ...
    for step in steps:
        ...
        T_step = T_anneal(T, step, num_steps, num_burnin, num_analysis)
        B_step = B_anneal(B, step, num_steps, num_burnin, num_analysis)
